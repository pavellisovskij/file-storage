...
export default {
    ...
    methods: {
        ...
        back() {
            Inertia.get(
                this.curFolder.parent_folder ?
                    route('storage.folder', { folder: this.curFolder.parent_folder.encoded_name }) :
                    route('storage.root')
            );
        }
    }
...
<template>
    <Head :title="curFolder.original_name" />

    <Layout>
        <button type="button" class="btn btn-light w-100 mb-3 text-start" @click="back()">
            <svg xmlns="http://www.w3.org/2000/svg" style="width: auto;" width="16" height="16" fill="currentColor" class="bi bi-arrow-return-left" viewBox="0 0 16 16">
        ...
        <div class="row row-cols-6 gy-2 text-center">
            <div v-for="folder in curFolder.children_folders" class="col">
                <div class="card"
            ...
            <div v-for="file in curFolder.files" class="col">
                <div class="card"
                     @click="
                        selectFile(file);
                        selectFolder(null);
